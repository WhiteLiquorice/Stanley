...
// State file lives in %APPDATA%\Stanley so it persists across installs
const STATE_DIR  = path.join(process.env.APPDATA || os.homedir(), 'Stanley');
const STATE_PATH = path.join(STATE_DIR, 'session_state.json');
