...
function App() {
  ...
  return (
    <div className="flex h-screen w-screen bg-[#090d16] text-[#f1f5f9] overflow-hidden select-none">
      ...
      {/* Right Console & Logs Panel / Configuration Drawer */}
      <aside className="w-80 border-l border-[#1e293b] bg-[#0b0f19] flex flex-col h-full z-20 shadow-[-10px_0_30px_rgba(0,0,0,0.5)]">
        {selectedNode ? (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-5 bg-[#070b12] text-sm">
              <div className="mb-6">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Step Name</label>
                <input 
                  type="text" 
              ...
              <div className="mb-6">
                ...
                <div className="px-3 py-2 bg-slate-900 border border-slate-800 rounded-lg text-slate-300 capitalize flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-indigo-500" />
                  {selectedNode.data.type.replace('_', ' ')}
                </div>
              </div>
              <div className="mb-6">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Configuration / Code</label>
                <textarea 
                  value={selectedNode.data.value}
                  readOnly
                  rows={4}
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-indigo-300 font-mono text-xs focus:outline-none"
                />
              </div>
              <button className="w-full py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold shadow-md shadow-indigo-500/20 transition-all">
                Update Settings
              </button>
            </div>
          </>
